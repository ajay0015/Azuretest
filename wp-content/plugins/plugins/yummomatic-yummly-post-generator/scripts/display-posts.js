...
registerBlockType( 'yummomatic-yummly-post-generator/yummomatic-display', {
    title: 'Yummomatic Display Posts',
    icon: 'carrot',
    category: 'embed',
    attributes: {
        ruletype : {
    ...
    keywords: ['display', 'posts', 'yummomatic'],
    edit: (function( props ) {
